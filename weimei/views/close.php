...
<body>
<div style='border-radius: 2px 2px 0 0;text-align:center;color:#000; box-shadow: 1px 1px 7px #000000; height: 180px; margin: 60px auto; width: 300px;'><h2 style=''>消息提示</h2><div style="font-size: 10pt;margin-top: 30px;"><br><?=$msg?>！<br><a href="#">如果你的浏览器没反应，请点击这里...</a><br></div></div>
</body>
</html>
